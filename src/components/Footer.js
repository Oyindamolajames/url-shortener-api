  ...
  return (
    ...
    <footer className="bg-slate-800 py-10 lg:py-20">
        <div className="max-width grid grid-cols-1 gap-5 md:grid-cols-3 lg:grid-cols-5" >
            ...
            <article>
                <h3 className="text-white text-lg font-bold trackig-wide">Features</h3>
            ...
            <article>
                <h3 className="text-white text-lg font-bold trackig-wide">Resources</h3>
            ...
            <article>
                <h3 className="text-white text-lg font-bold trackig-wide">Company</h3>
                ...
                <ul>
                    ...
                    <li><button className="text-slate-200 text-sm mt-1" >Carrears</button></li>
