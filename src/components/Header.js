    ...
    <>
      <header className="header max-width py-5">
        <div className="flex items-center justify-between">
          ...
          {isOpen && (
            <div
              className="absolute left-5 right-5 top-20 rounded bg-slate-900 text-slate-200 
                    text-center py-5 md:relative md:left-0 md:right-0 md:top-0 md:bg-transparent 
                    md:text-slate-700 md:text-left md:py-0 md:flex md:items-center"
            >
              ...
              <ul className="flex flex-col items-center justify-center">
                <li className="my-5 md:my-0 md:mr-5 text-slate-400">
                  <button>Login</button>
                </li>
                <li>
