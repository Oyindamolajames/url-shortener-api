...
export default function Advanced() {
  return (
    <>
    <section className="bg-gray-100 pt-32 pb-10 py-10 pb-40">
  ...
  mean a thing. Branded links help instil confidence in your content.</p>
            ...
            <article className="bg-white p-5 rounded relative">
                <img src={detail} alt="" className="p-4 -mt-12 bg-slate-800 rounded-full"/>
  ...
  people engage with your content helps inform better decisions.</p>
            ...
            <article className="bg-white p-5 rounded relative">
                <img src={customizable} alt="" className="p-4 -mt-12 bg-slate-800 rounded-full"/>
